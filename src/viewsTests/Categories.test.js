...
describe("Categories", () => {
  ...
  it("displays proper elements after content loads", async () => {
    ...
    await act(async () => {
      ...
      getByText("testMeal2");
      getByText("testMeal3");
      expect(getAllByRole("category-card-img")[0]).toHaveAttribute(
        "src",
        "https://www.themealdb.com/images/media/meals/svprys1511176755.jpg"
      );
      expect(getAllByRole("category-card-img")[1]).toHaveAttribute(
        "src",
        "https://www.themealdb.com/images/media/meals2/svprys1511176755.jpg"
      );
      expect(getAllByRole("category-card-img")[2]).toHaveAttribute(
        "src",
        "https://www.themealdb.com/images/media/meals3/svprys1511176755.jpg"
      );
    });
